import RegisterLenderBox from "../borrower-view/components/register-lender-box";

export default function RegisterLenderTemplate() {
  return (
    <>
      <RegisterLenderBox
        link="https://i.imgur.com/n7Xy896.png"
